CREATE TABLE IF NOT EXISTS "user_memories" (
	...
	"title" varchar(255),
	"summary" text,
	"summary_vector_1024" vector(2048),
	"details" text,
	"details_vector_1024" vector(2048),
	"status" varchar(255),
...
CREATE TABLE IF NOT EXISTS "user_memories_contexts" (
	...
	"title" text,
	"title_vector" vector(2048),
	"description" text,
	"description_vector" vector(2048),
	"type" varchar(255),
	"current_status" text,
...
CREATE TABLE IF NOT EXISTS "user_memories_experiences" (
	...
	"type" varchar(255),
	"situation" text,
	"situation_vector" vector(2048),
	"reasoning" text,
	"possible_outcome" text,
	"action" text,
	"action_vector" vector(2048),
	"key_learning" text,
	"key_learning_vector" vector(2048),
	"metadata" jsonb,
...
CREATE TABLE IF NOT EXISTS "user_memories_preferences" (
	...
	"conclusion_directives_vector" vector(2048),
	"type" varchar(255),
	"suggestions" text,
